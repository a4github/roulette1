...
class Roulette():
    ...
    def __init__(self,mode,o_filename,db_filename):

        #self.output_filename = "roulette1/data.txt"
        self.dbpath = db_filename
    ...
    def SaveSqlite(self):
        ...
        self.cursor.execute("delete from deme;")

        for i in range(len(self.numberhistory)):
            self.cursor.execute("INSERT INTO deme valueS (:id, :number, :color, :eo)",
